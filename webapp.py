...
class SAREXPLORER():
  ...
  def display_gif(self):
  	...
  	file_.close()
  	st.markdown(
    f'<img src="data:image/gif;base64,{data_url}" alt="Base Timeseries">',
...
if __name__ == '__main__':
	base_name = st.selectbox('Which location would you like to examine?',('Lesnovka', 'Klintsy', 'Unecha', 'Klimovo Air Base', 'Yelnya', 'Kursk', 'Pogonovo training ground', 'Valuyki', 'Soloti', 'Opuk', 'Bakhchysarai', 'Novoozerne', 'Dzhankoi', 'Novorossiysk', 'Raevskaya'))
